...
public class Person : MonoBehaviour
{
	...
	void Start ()
	{
		if (maxSkinTint < minSkinTint)
			maxSkinTint = minSkinTint;
	                               ...
	                               bool noAnimation = false)
	{
		...
		StartCoroutine (Horrible (trait, t, variationID, sprite, isBlanco, noAnimation));
	}

	private IEnumerator Horrible (S.String trait, TraitOpts t, int variationID,
	                              Sprite sprite, bool isBlanco,
	                              bool noAnimation)
	{
